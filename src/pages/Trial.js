...
const imgStyles = [
    {style: { left:"5%", top: "7%", writable: true}, src: "BFH/BFH" + (Math.floor(Math.random() * 10) + 1) + ".jpg"},
    {style: { left: "10%", top: "60%"}, src: "BFL/BFL" + (Math.floor(Math.random() * 10) + 1) + ".jpg"},
    {style: { left: "30%", top: "20%"}, src: "BMH/BMH" + (Math.floor(Math.random() * 10) + 1) + ".jpg"},
    {style: { left: "35%", top: "75%"}, src: "BML/BML" + (Math.floor(Math.random() * 10) + 1) + ".jpg"},
    {style: { left: "53%", top: "50%"}, src: "WFH/WFH" + (Math.floor(Math.random() * 10) + 1) + ".jpg"},
    {style: { left: "65%", top: "15%"}, src: "WFL/WFL" + (Math.floor(Math.random() * 10) + 1) + ".jpg"},
    {style: { left: "75%", top: "65%"}, src: "WMH/WMH" + (Math.floor(Math.random() * 10) + 1) + ".jpg"},
